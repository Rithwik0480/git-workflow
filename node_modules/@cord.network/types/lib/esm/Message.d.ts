...
export type MessageBodyType = 'error' | 'reject' | 'request-document-stream' | 'submit-document-stream' | 'reject-document-stream' | 'request-credential-document' | 'submit-credential-document' | 'accept-credential-document' | 'reject-credential-document';
...
export type MessageBody = IError | IReject | IRequestDocument | ISubmitDocumentStream | IRejectDocumentStream | IRequestCredentialDocument | ISubmitCredentialDocument | IAcceptCredentialDocument | IRejectCredentialDocument;
/**
