...
import { SCHEMA_PREFIX, REGISTRY_PREFIX, STREAM_PREFIX, SCORE_PREFIX, AUTHORIZATION_PREFIX, } from '@cord.network/types';
import { ACCOUNT_IDENTIFIER_PREFIX, REGISTRY_IDENT, SCHEMA_IDENT, STREAM_IDENT, SCORE_IDENTIFIER, AUTHORIZATION_IDENT, } from '@cord.network/types';
const defaults = {
