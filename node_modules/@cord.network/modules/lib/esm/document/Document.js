 ...
 */
export function removeContentProperties(document, properties) {
    const presentation = 
...
export function verifyDocumentHash(input) {
...
export function verifyAuthorization(input, authorizationDetails) {
 ...
 */
export function verifyAgainstSchema(document, schema) {
 ...
 */
export function getUriForStream(streamDigest, registry, creator) {
 ...
 */
export async function fromContent({ content, authorization, registry, signCallback, 
// evidenceIds,
options = {}, }) {
 ...
 */
export async function verifyDocument(document, { schema } = {}) {
    verifyDataStructure(document);
 ...
 */
export function isIDocument(input) {
    try {
 ...
 */
export function getHash(document) {
 ...
 */
export async function createPresentation({ document, signCallback, selectedAttributes, challenge, }) {
